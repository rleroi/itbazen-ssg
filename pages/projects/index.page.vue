  ...
  <div class="space-y-4">
    ...
    <div class="rounded-md border border-border p-4 flex flex-col md:flex-row">
      ...
      <div class="md:w-1/2 flex flex-col">
        <div>
          <h4 class="text-3xl mb-4">
            <a target="_blank" rel="noopener" title="Stremio Streaming Catalogs Addon" href="https://github.com/rleroi/stremio-netflix-catalog-addon">
              Stremio Addon
              <svg width="32" height="32" class="hover:fill-white/50 fill-white inline"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                <g>
          ...
          <div class="text-white/50">
            Streaming catalogs addon.<br />
            Shows metadata from popular streaming platforms in <a class="hover:text-white transition-colors" target="_blank" rel="noopener"
              title="Chip8 emulator and debugger in VueJS" href="https://stremio.com">Stremio</a>.<br />
              <a class="hover:text-white transition-colors" target="_blank" rel="noopener"
              title="Chip8 emulator and debugger in VueJS" href="https://7a82163c306e-stremio-netflix-catalog-addon.baby-beamup.club/configure">Install addon to Stremio</a>
          </div>
        </div>
        <div class="mt-auto">
          <h5 class="text-xl my-4">Technologies</h5>
      ...
      <div class="md:w-1/2 mt-8 md:mt-0">
        <img class="rounded-sm" alt="Stremio Streaming Catalogs Addon"
          src="https://user-images.githubusercontent.com/6817390/216839228-f0d09dfd-e76b-4d23-bf4f-cab09febd1ef.png" />
      </div>
    </div>
